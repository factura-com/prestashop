...
<div class="header-container" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
    <h1 style="margin: 0;">{l s='List of Invoices' mod='facturapuntocom'}</h1>
</div>
...
<div class="container-fluid">
      ...
      <table id="tabla" class="display" width="100%" cellspacing="0">
          <thead>
            <tr>
              ...
              <th>{l s='RFC' mod='facturapuntocom'}</th>
              <th>{l s='Order' mod='facturapuntocom'}</th>
              <th>{l s='Downloads' mod='facturapuntocom'}</th>
              <th>{l s='Options' mod='facturapuntocom'}</th>
            </tr>
          </thead>
          <tbody>
  ...
  function downloadFile(uid, type) {
    ...
    form.method = 'POST';
    form.action = url_admin;
    form.target = '_blank'; // Abrir en nueva pestaña
    
    // Agregar los campos necesarios
    var controllerField = document.createElement('input');
    controllerField.type = 'hidden';
    controllerField.name = 'controller';
    controllerField.value = 'AdminFactura';
    form.appendChild(controllerField);
    
    var actionField = document.createElement('input');
    actionField.type = 'hidden';
    actionField.name = 'action';
    actionField.value = 'downloadFile';
